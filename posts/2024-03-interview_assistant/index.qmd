...
### **Technical interesting fact about this project**

This project marked my first venture into using [Rhino](https://appsilon.github.io/rhino/), an application from Appsilon, which enabled me to implement unit and end-to-end tests (with Cypress), facilitating continuous integration through GitHub Actions. It was a great experience.
